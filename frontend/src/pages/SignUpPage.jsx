...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      {/* left side */}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className="input input-bordered w-full pl-10 bg-gray-700 border-gray-600 text-white"
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  className="input input-bordered w-full pl-10 bg-gray-700 border-gray-600 text-white"
                  placeholder="lenmonireach@example.com"
